 ...
 *                   ------------------------------------
 *                   模块管脚            单片机管脚
 *                   SCL                 查看 SEEKFREE_DL1A_2.h 中 DL1A_2_SCL_PIN   宏定义
 *                   SDA                 查看 SEEKFREE_DL1A_2.h 中 DL1A_2_SDA_PIN   宏定义
 *					 XS					 查看 SEEKFREE_DL1A_2.h 中 DL1A_2_XSHUT_PIN 宏定义
 *                   VCC                 5V 电源
 *                   GND                 电源地
 *                   ------------------------------------
 ********************************************************************************************************************/
...
#define DL1A_2_SCL_PIN (P10) // 软件 IIC SCL 引脚 连接 DL1A 的 SCL 引脚
#define DL1A_2_SDA_PIN (P11) // 软件 IIC SDA 引脚 连接 DL1A 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================

#define DL1A_2_XSHUT_PIN (P36)
