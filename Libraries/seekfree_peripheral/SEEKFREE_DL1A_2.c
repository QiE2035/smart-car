 ...
 *                   ------------------------------------
 *                   模块管脚            单片机管脚
 *                   SCL                 查看 SEEKFREE_DL1A.h 中 DL1A_2_SCL_PIN   宏定义
 *                   SDA                 查看 SEEKFREE_DL1A.h 中 DL1A_2_SDA_PIN   宏定义
 *					 XS					 查看 SEEKFREE_DL1A.h 中 DL1A_2_XSHUT_PIN 宏定义
 *                   VCC                 5V 电源
 *                   GND                 电源地
 *                   ------------------------------------
********************************************************************************************************************/
...
uint8 dl1a_2_finsh_flag;
uint16 dl1a_2_distance_mm;



#define GET_DL1A_SDA   		 	DL1A_2_SDA_PIN
#define DL1A_SDA_LOW()         	DL1A_2_SDA_PIN = 0		//IO口输出低电平
#define DL1A_SDA_HIGH()        	DL1A_2_SDA_PIN = 1		//IO口输出高电平

#define DL1A_SCL_LOW()          	DL1A_2_SCL_PIN = 0		//IO口输出低电平
#define DL1A_SCL_HIGH()         	DL1A_2_SCL_PIN = 1		//IO口输出高电平
...
void dl1a_2_get_distance (void)
{
    ...
    else
    {
        ...
        dl1a_2_distance_mm = ((uint16)reg_databuffer[0] << 8);
        dl1a_2_distance_mm |= reg_databuffer[1];
